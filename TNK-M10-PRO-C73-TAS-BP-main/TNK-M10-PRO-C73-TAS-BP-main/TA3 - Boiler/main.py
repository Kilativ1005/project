...
while True:
    ...
    try:
        image = cv2.putText(image, classNames[2:], (10, 30), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 0, 0), 3)
        image = cv2.putText(image, str(np.round(confidenceScore*100)) [:-2], (15, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 3 )
    except:
        pass
